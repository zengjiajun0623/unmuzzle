# -*- coding: utf-8 -*-
"""Eval DeepSeek-V4-Flash in FULL BF16 (device_map=auto across 8xH100) on the
265-item benchmark, V4 encoder (chat mode). base or base+LoRA adapter."""
...
print("loading full bf16 (device_map=auto)...", flush=True)
